...
function safeGitAdd(repoRoot, filePath) {
  ...
  // Use -- terminator to prevent option injection
 ...
 * }
 */
// eslint-disable-next-line complexity -- parseCliArgs has inherent branching (complexity 19), refactoring would reduce readability
