...
const _DEDUPED_FILE = INPUT_FILE;
...
function assignStableId(item, idMap, usedIds, nextId) {
  let existingId = null;
  if (item.fingerprint) {
    // eslint-disable-next-line framework/no-sql-injection -- no SQL here, string interpolation for log/display output
...
function _writeMasterFile(items) {
...
function _mergeManualItems(items) {
