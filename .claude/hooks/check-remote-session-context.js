 ...
 * causing session context to appear stale on the current branch.
 */
...
/**
 * Get recent branches with the claude/ prefix
 */
...
function main() {
  ...
  if (newerBranch && newerCounter > localCounter) {
    console.error('');
    console.error('WARNING: SESSION CONTEXT UPDATE DETECTED');
