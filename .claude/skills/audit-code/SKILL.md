...
- Framework Best Practices (framework patterns and conventions)
- Testing Coverage (untested functions, missing edge cases)

**Files:**

- `src/**/*.tsx` (routing, layouts)
...
- Display: "No review thresholds triggered. Proceed anyway? (This is a
...
3. Framework Best Practices (framework patterns and conventions)
...
7. Debugging (Debugging Ergonomics):
   - Correlation IDs / request tracing
   - Structured logging with context (not just console.log)
   - Error tracking integration completeness
