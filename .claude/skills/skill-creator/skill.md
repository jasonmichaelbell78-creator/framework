---
name: skill-creator
description: Guide for creating effective skills. This skill should be used when users want
...
When creating from scratch, create the skill directory with SKILL.md template,
frontmatter, and example resource directories as needed. Customize or remove
generated files as needed.
...
Validate the skill meets all requirements by reviewing against the content
checklist in Step 4.2. Check structural quality (frontmatter, sections, line
count) and behavioral quality.
